...
public class MainActivity extends AppCompatActivity
    ...
    private QuoteService.IQuoteReceiver quoteReceiver = new QuoteService.IQuoteReceiver() {
        @Override
        public void onQuote(String quote) {
            TextView mainText = findViewById(R.id.text_main);
            mainText.setText(quote);
        }
        ...
        public void onError(Exception e) {
            TextView mainText = findViewById(R.id.text_main);
            e.printStackTrace();
            Snackbar.make(mainText, e.toString(), Snackbar.LENGTH_LONG).show();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                quoteService.getQuote(quoteReceiver);
            }
        });
